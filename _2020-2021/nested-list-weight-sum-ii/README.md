<h2>364. Nested List Weight Sum II</h2><h3>Medium</h3><hr><div><p>Given a nested list of integers, return the sum of all integers in the list weighted by their depth.</p>
