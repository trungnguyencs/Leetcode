<h2>246. Strobogrammatic Number</h2><h3>Easy</h3><hr><div><p>A strobogrammatic number is a number that looks the same when rotated 180 degrees (looked at upside down).</p>
